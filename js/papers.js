...
function paperStateKey(paperId) {
  return `jlpt-n4-tutor.paper.${paperId}`;
}
...
async function renderCategoryIndex(container) {
  ...
  container.innerHTML = `
    <article class="papers-index">
      ...
      <p class="page-lede">${m.totalQuestions} audited JLPT N4 questions across ${m.totalPapers} papers in 4 sections. Each paper is sized to a study-session (15 questions, ~10 minutes). Scores persist locally so you can track which papers you've completed.</p>
