...
118 entries from the alphabetical a-h sample, distributed across 18 thematic sections.

## 1. People and relationships

- 赤ちゃん (akachan) - [n.] baby; infant [tier:core_n4] [examples:0]
- 赤ん坊 (akanbou) - [n.] baby; infant [tier:core_n4] [examples:0]
- アナウンサー (anaunsaa) - [n.] announcer [tier:core_n4] [examples:0]
- あんな (anna) - [dem.] such [tier:core_n4] [examples:0]
- 僕 (boku) - [pron.] I (used by males) [tier:core_n4] [examples:0]
- 部長 (buchou) - [n.] manager; head of a section or department [tier:core_n4] [examples:0]
- ちゃん (chan) - [n.] suffix for familiar female person [tier:core_n4] [examples:0]
- 男性 (dansei) - [n.] man; male [tier:core_n4] [examples:0]
- 泥棒 (dorobou) - [n.] thief [tier:core_n4] [examples:0]
- ご主人 (goshujin) - [n.] your husband; her husband [tier:core_n4] [examples:0]
- 歯医者 (haisha) - [n.] dentist [tier:core_n4] [examples:0]

## 2. Home and daily life

- 美術館 (bijutsukan) - [n.] art gallery; art museum [tier:core_n4] [examples:0]
- ビル (biru) - [n.] building [tier:core_n4] [examples:0]
- 道具 (dougu) - [n.] tool [tier:core_n4] [examples:0]
- 布団 (futon) - [n.] Japanese bedding, futon [tier:core_n4] [examples:0]
- ガソリン (gasorin) - [n.] gasoline; petrol [tier:core_n4] [examples:0]
- 下宿 (geshuku) - [n.] lodging [tier:core_n4] [examples:0]
- ごみ (gomi) - [n.] rubbish [tier:core_n4] [examples:0]

## 3. School and study

- 文学 (bungaku) - [n.] literature [tier:core_n4] [examples:0]
- 文化 (bunka) - [n.] culture [tier:core_n4] [examples:0]
- 文法 (bunpou) - [n.] grammar [tier:core_n4] [examples:0]
- 地理 (chiri) - [n.] geography [tier:core_n4] [examples:0]
- 中学校 (chuugakkou) - [n.] junior high school; middle school [tier:core_n4] [examples:0]
- 大学生 (daigakusei) - [n.] university student; college student [tier:core_n4] [examples:0]
- 復習 (fukushuu) - [n.] review of learned material; revision [tier:core_n4] [examples:0]

## 4. Work and society

- Format: `KANJI/KANA (READING (romaji)) - [n.] ENGLISH [tier:core_n4] [examples:0]
- 挨拶 (aisatsu) - [n.] to greet [tier:core_n4] [examples:0]
- 案内 (annai) - [n.] to guide [tier:core_n4] [examples:0]
- 遊び (asobi) - [n.] playing [tier:core_n4] [examples:0]
- 倍 (bai) - [n.] double [tier:core_n4] [examples:0]
- 番組 (bangumi) - [n.] program (e.g. TV) [tier:core_n4] [examples:0]
- 場所 (basho) - [n.] place [tier:core_n4] [examples:0]
- ベル (beru) - [n.] bell [tier:core_n4] [examples:0]
- 貿易 (boueki) - [n.] trade [tier:core_n4] [examples:0]
- チェック (chekku) - [n.] to check [tier:core_n4] [examples:0]
- 力 (chikara) - [n.] energy; force; strength; might; power [tier:core_n4] [examples:0]
- 大体 (daitai) - [n.] roughly [tier:core_n4] [examples:0]
- 暖房 (danbou) - [n.] heating [tier:core_n4] [examples:0]
- 電報 (denpou) - [n.] telegram [tier:core_n4] [examples:0]
- 電灯 (dentou) - [n.] electric light [tier:core_n4] [examples:0]
- 動物園 (doubutsuen) - [n.] zoo; zoological gardens [tier:core_n4] [examples:0]
- 枝 (eda) - [n.] branch [tier:core_n4] [examples:0]
- ファックス (fakkusu) - [n.] fax [tier:core_n4] [examples:0]
- 船 (fune) - [n.] ship [tier:core_n4] [examples:0]
- 普通 (futsuu) - [n.] usually [tier:core_n4] [examples:0]
- ガラス (garasu) - [n.] a glass [tier:core_n4] [examples:0]
- ガス (gasu) - [n.] petrol [tier:core_n4] [examples:0]
- 原因 (genin) - [n.] cause [tier:core_n4] [examples:0]
- 技術 (gijutsu) - [n.] art, technology, skill [tier:core_n4] [examples:0]
- ご存じ (gozonji) - [n.] knowing [tier:core_n4] [examples:0]
- 拝見 (haiken) - [n.] seeing; looking at [tier:core_n4] [examples:0]
- 発音 (hatsuon) - [n.] pronunciation [tier:core_n4] [examples:0]

## 5. Travel and transportation

- アフリカ (afurika) - [n.] Africa [tier:core_n4] [examples:0]
- アジア (ajia) - [n.] Asia [tier:core_n4] [examples:0]
- アメリカ (amerika) - [n.] America [tier:core_n4] [examples:0]
- 駐車場 (chuushajou) - [n.] parking lot [tier:core_n4] [examples:0]
- エスカレーター (esukareetaa) - [n.] escalator [tier:core_n4] [examples:0]
- ガソリンスタンド (gasorin sutando) - [n.] petrol station [tier:core_n4] [examples:0]

## 6. Shopping and money

- アクセサリー (akusesarii) - [n.] accessory [tier:core_n4] [examples:0]
- アルバイト (arubaito) - [n.] part-time job [tier:core_n4] [examples:0]
- ハンドバッグ (handobaggu) - [n.] handbag [tier:core_n4] [examples:0]

## 7. Food and restaurants

- 味 (aji) - [n.] flavor; taste; uniqueness; attractiveness; experience [tier:core_n4] [examples:0]
- アルコール (arukooru) - [n.] alcohol [tier:core_n4] [examples:0]
- ぶどう (budou) - [n.] grapes [tier:core_n4] [examples:0]
- ごちそう (gochisou) - [n.] a feast [tier:core_n4] [examples:0]
- 葉 (ha) - [n.] leaves; leaf [tier:core_n4] [examples:0]

## 8. Health and body

- 血 (chi) - [n.] blood [tier:core_n4] [examples:0]
- 注意 (chuui) - [n.] caution [tier:core_n4] [examples:0]
- 注射 (chuusha) - [n.] injection [tier:core_n4] [examples:0]
- 具合 (guai) - [n.] condition; health [tier:core_n4] [examples:0]

## 9. Weather and nature

- 遠慮 (enryo) - [n.] reserve; refraining [tier:core_n4] [examples:0]
- 花見 (hanami) - [n.] cherry blossom viewing; flower viewing [tier:core_n4] [examples:0]
- 林 (hayashi) - [n.] woods; forest [tier:core_n4] [examples:0]
...
- 上がる (agaru) - [v1] to rise [tier:core_n4] [examples:0]
- 挨拶する (aisatsuする) - [v3] to greet [tier:core_n4] [examples:0]
- 案内する (annaiする) - [v3] to guide [tier:core_n4] [examples:0]
- アルバイトする (arubaitoする) - [v3] to part-time job [tier:core_n4] [examples:0]
- 集まる (atsumaru) - [v1] to gather; to collect; to assemble [tier:core_n4] [examples:0]
- 集める (atsumeru) - [v2] to collect; to assemble; to gather [tier:core_n4] [examples:0]
- 謝る (ayamaru) - [v1] to apologize [tier:core_n4] [examples:0]
- 貿易する (bouekiする) - [v3] to trade [tier:core_n4] [examples:0]
- チェックする (chekkuする) - [v3] to check [tier:core_n4] [examples:0]
- 注意する (chuuiする) - [v3] to caution [tier:core_n4] [examples:0]
- 注射する (chuushaする) - [v3] to injection [tier:core_n4] [examples:0]
- 暖房する (danbouする) - [v3] to heating [tier:core_n4] [examples:0]
- 遠慮する (enryoする) - [v3] to reserve [tier:core_n4] [examples:0]
- 選ぶ (erabu) - [v1] to choose [tier:core_n4] [examples:0]
- ファックスする (fakkusuする) - [v3] to fax [tier:core_n4] [examples:0]
- 増える (fueru) - [v2] to increase [tier:core_n4] [examples:0]
- 復習する (fukushuuする) - [v3] to review of learned material [tier:core_n4] [examples:0]
- 踏む (fumu) - [v1] to step on [tier:core_n4] [examples:0]
- 降り出す (furidasu) - [v1] to start to rain [tier:core_n4] [examples:0]
- 太る (futoru) - [v1] to become fat [tier:core_n4] [examples:0]
- 原因する (geninする) - [v3] to cause [tier:core_n4] [examples:0]
- 下宿する (geshukuする) - [v3] to lodging [tier:core_n4] [examples:0]
- ごちそうする (gochisouする) - [v3] to a feast [tier:core_n4] [examples:0]
- 拝見する (haikenする) - [v3] to seeing [tier:core_n4] [examples:0]
- 運ぶ (hakobu) - [v1] to carry [tier:core_n4] [examples:0]
- 花見する (hanamiする) - [v3] to cherry blossom viewing [tier:core_n4] [examples:0]
- 払う (harau) - [v1] to pay [tier:core_n4] [examples:0]
- 発音する (hatsuonする) - [v3] to pronunciation [tier:core_n4] [examples:0]

## 13. I-adjectives

- 浅い (asai) - [i-adj] shallow [tier:core_n4] [examples:0]
- 深い (fukai) - [i-adj] deep [tier:core_n4] [examples:0]
- 恥ずかしい (hazukashii) - [i-adj] embarrassed [tier:core_n4] [examples:0]

## 14. Na-adjectives

- 安心 (anshin) - [na-adj] peace of mind [tier:core_n4] [examples:0]
- 安全 (anzen) - [na-adj] safety; security [tier:core_n4] [examples:0]
- 大事 (daiji) - [na-adj] important; serious; crucial [tier:core_n4] [examples:0]
- 不便 (fuben) - [na-adj] inconvenience [tier:core_n4] [examples:0]
- 複雑 (fukuzatsu) - [na-adj] complexity; complication [tier:core_n4] [examples:0]
- 反対 (hantai) - [na-adj] opposition [tier:core_n4] [examples:0]

## 15. Adverbs

- ああ (aa) - [adv.] ah; yes [tier:core_n4] [examples:0]
- びっくり (bikkuri) - [adv.] to be surprised [tier:core_n4] [examples:0]
- 大分 (daibu) - [adv.] considerably; greatly; a lot [tier:core_n4] [examples:0]
- できるだけ (dekiru dake) - [adv.] as much as possible [tier:core_n4] [examples:0]
- どんどん (dondon) - [adv.] rapidly; more and more [tier:core_n4] [examples:0]
- はっきり (hakkiri) - [adv.] clearly [tier:core_n4] [examples:0]
...
- あ (a) - [exp.] Ah; oh [tier:core_n4] [examples:0]
- ご覧になる (goran ni naru) - [exp.] (respectful) to see [tier:core_n4] [examples:0]
