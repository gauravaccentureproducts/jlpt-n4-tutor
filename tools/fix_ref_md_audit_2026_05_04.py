...
Items:
  §1.1 HIGH    kanji_n4.md - apply [N4+] flag to ~19 entries with out-of-scope readings
  §1.2 HIGH    kanji_n4.md - reorder 入 kun (い → はい first)
  §1.3 HIGH    vocab POS mistags in §1 (Pronouns) + §12 (Time-Frequency).
               BOTH vocabulary_n4.md AND data/vocab.json need updates so JA-31 stays green.
  §1.4 HIGH    grammar_n4.md - add Verb + ことができる pattern
  §2.1 MED     grammar_n4.md - add から particle option to もらう
  §2.2 MED     grammar_n4.md - replace combined もの+んだ example with cleaner one
  §2.3 MED     grammar_n4.md - drop ごはん from bika-go example list (lexicalized)
  §2.4 MED     grammar_n4.md - Genki citation L8/L10 → L8 / L9
  §2.5 MED     sources.md - add JLPT.jp N5 sample-paper PDFs reference
  §3.1 LOW     sources.md - add NHK NEWS WEB EASY reference
  §3.2 LOW     grammar_n4.md - register caveat on prohibitive な
...
# =====================================================================
# §1.1 + §1.2: kanji_n4.md scope flags + 入 kun reorder
# =====================================================================
...
# =====================================================================
# §1.3: vocab POS mistags — fix BOTH vocab.json AND vocabulary_n4.md
# =====================================================================
def fix_vocab_pos() -> None:
    ...
    for old, new in MD_FIXES:
        if old in text:
            text = text.replace(old, new, 1)
            changes.append(f'§1.3 vocabulary_n4.md: {old[:30]}... → {new.split("- ")[2][:30]}...')
    write(md, text)


# =====================================================================
# §1.4: grammar_n4.md - add Verb + ことができる pattern
# =====================================================================
...
def fix_sources() -> None:
    ...
    if 'N5 Sample Questions' not in text and 'サンプル問題' not in text:
        ...
        insertion = (
            ...
            '「JLPT N4 サンプル問題」 in this project for format-fidelity '
