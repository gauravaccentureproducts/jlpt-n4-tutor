...
plus vocabulary_n4.md sync (JA-31 invariant enforces parity). Naive
...
# vocabulary_n4.md PoS-tag short forms (matches existing tooling)
POS_TAG_SHORT = {
    'noun':         'n.',
    'verb-1':       'v1',
    'verb-2':       'v2',
...
def fix_vocab_md(md_text, fixed_entries):
    """For each fixed entry, find the line in vocabulary_n4.md and update its
...
def main():
    ...
    mdp = ROOT / 'KnowledgeBank' / 'vocabulary_n4.md'
    ...
    print(f'\nKnowledgeBank/vocabulary_n4.md: {len(md_fixes)} fixed, {len(md_skipped)} skipped')
