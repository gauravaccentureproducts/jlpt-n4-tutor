...
# ---------- 3.1: add 半分 to n4_vocab_whitelist.json ----------
def fix_vocab_whitelist() -> int:
    wpath = ROOT / 'data' / 'n4_vocab_whitelist.json'
