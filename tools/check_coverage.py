"""Check that every pattern listed in KnowledgeBank/grammar_n4.md has an entry in data/grammar.json.
...
def main() -> int:
    grammar_md = ROOT / "KnowledgeBank" / "grammar_n4.md"
    ...
    print(f"KnowledgeBank/grammar_n4.md : {len(md_patterns):>4} pattern entries")
    ...
    if len(json_patterns) < len(md_patterns):
        ...
        print(
            f"INCOMPLETE: {missing} pattern(s) in KnowledgeBank/grammar_n4.md not yet authored "
